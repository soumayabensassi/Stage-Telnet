...
class ResetPasswordController extends AbstractController
{
     ...
     */
    public function reset(Request $request, UserPasswordEncoderInterface $userPasswordEncoder, string $token = null,EntityManagerInterface $a,UserPasswordEncoderInterface $b): Response
    {
        if ($token) {
